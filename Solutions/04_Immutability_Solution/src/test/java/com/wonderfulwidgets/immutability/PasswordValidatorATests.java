...
public class PasswordValidatorATests {
	...
	@Test
	public void PasswordValidatorComplaintSucceeds() throws IOException {
		...
		IPasswordValidator validator = new PasswordValidatorA();
		...
		// Clear the target to make sure it is out of memory, then assert Validator.check left memory clean.
