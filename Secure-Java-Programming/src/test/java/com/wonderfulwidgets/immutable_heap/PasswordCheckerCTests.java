...
import com.wonderfulwidgets.immutable_heap.PasswordCheckerC;

public class PasswordCheckerCTests extends PasswordCheckerTestsBase {
	
	public PasswordCheckerCTests() throws IOException {
	}
	...
	public void PasswordCheckerComplaintSucceeds() throws IOException {
		...
		PasswordChecker checker = new PasswordCheckerC();
