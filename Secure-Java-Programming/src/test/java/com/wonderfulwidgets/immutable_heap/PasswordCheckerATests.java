...
import com.wonderfulwidgets.immutable_heap.PasswordCheckerA;

public class PasswordCheckerATests extends PasswordCheckerTestsBase {
	
	public PasswordCheckerATests() throws IOException {
	}
	...
	public void PasswordCheckerComplaintSucceeds() throws IOException {
		...
		PasswordChecker checker = new PasswordCheckerA();
