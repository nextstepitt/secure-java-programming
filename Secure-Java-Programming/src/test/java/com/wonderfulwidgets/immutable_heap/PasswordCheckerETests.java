...
import com.wonderfulwidgets.immutable_heap.PasswordCheckerE;

public class PasswordCheckerETests extends PasswordCheckerTestsBase {
	
	public PasswordCheckerETests() throws IOException {
	}
	...
	public void PasswordCheckerComplaintSucceeds() throws IOException {
		...
		PasswordChecker checker = new PasswordCheckerE();
