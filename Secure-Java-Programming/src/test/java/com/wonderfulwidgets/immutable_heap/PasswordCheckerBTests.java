...
import com.wonderfulwidgets.immutable_heap.PasswordCheckerB;

public class PasswordCheckerBTests extends PasswordCheckerTestsBase {
	
	public PasswordCheckerBTests() throws IOException {
	}
	...
	public void PasswordCheckerComplaintSucceeds() throws IOException {
		...
		PasswordChecker checker = new PasswordCheckerB();
